    ...
    <div id="wrapper">
        ...
        <nav id="navigationNavar" class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url();?>dealerAdmin/">HitoFun</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        ...
                        &nbsp;
                        <?php
                            if($dealer->dealerType == 1) {
                                echo($dealer->dealerCompanyName);
                            } elseif($dealer->dealerType == 2) {
                                echo($dealer->dealerFirstName . $dealer->dealerLastName);
                            }
                        ?>
                        &nbsp;
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="<?php echo base_url();?>dealerAdmin/dashboard/changePassword"><i class="fa fa-gear fa-fw"></i> 修改密碼</a>
                        </li>
                        <li class="divider"></li>
                        <li><a href="<?php echo base_url();?>dealerAdmin/login/logout"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <?php if(array_key_exists('menu_dashboard', $userMenuList)) {?>
                            <li>
                                <a href="<?php echo base_url();?>dealerAdmin/dashboard" class="<?php if($this->uri->segment(2) == 'dashboard') {echo('active');}?>"><i class="fa fa-dashboard fa-fw"></i> <?php echo($userMenuList['menu_dashboard']);?></a>
                            </li>
                        <?php }?>
                         <?php if(array_key_exists('menu_order', $userMenuList)) {?>
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <!-- <li>
                                        <a href="<?php// echo base_url();?>dealerAdmin/order/general" class="<?php //if($this->uri->segment(3) == 'general' || $this->uri->segment(6) == '1') {echo('active');}?>">一般訂房</a>
                                    </li>
                                    <li>
                                        <a href="<?php //echo base_url();?>dealerAdmin/order/lastMinute" class="<?php// if($this->uri->segment(3) == 'lastMinute' || $this->uri->segment(6) == '2') {echo('active');}?>">最後一分鐘</a>
                                    </li> -->
                                    <li>
                                        <a href="<?php echo base_url();?>dealerAdmin/order/obo" class="<?php if($this->uri->segment(3) == 'obo' || $this->uri->segment(5) == '3') {echo('active');}?>">一口價</a>
                                    </li>
                                </ul>
                                <!-- /.nav-second-level -->
                            </li>
        ...
        <!-- Page Content -->
        <div id="page-wrapper">
            <?php $this->load->view('dealerAdmin/' . $view, $contentData);?>
        </div>
        <!-- /#page-wrapper -->
