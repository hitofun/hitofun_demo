    ...
    <div id="wrapper">
        ...
        <nav id="navigationNavar" class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url();?>hotelAdmin/">HitoFun</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <i class="fa fa-user fa-fw"></i>&nbsp;<?php echo($this->ion_auth_hotelier->user()->row()->first_name . $this->ion_auth_hotelier->user()->row()->last_name);?>&nbsp;<i class="fa fa-caret-down"></i>
                    </a>
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="<?php echo base_url();?>hotelAdmin/dashboard/changePassword"><i class="fa fa-gear fa-fw"></i> 修改密碼</a>
                        </li>
                        <li class="divider"></li>
                        <li><a href="<?php echo base_url();?>hotelAdmin/login/logout"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <?php if(array_key_exists('menu_dashboard', $userMenuList)|| array_key_exists('menu_lastMinutePolicy', $userMenuList)
                                || array_key_exists('menu_lastMinuteRoom', $userMenuList)) {?>
                            <li>
                                <a href="<?php echo base_url();?>hotelAdmin/dashboard" class="<?php if($this->uri->segment(2) == 'dashboard') {echo('active');}?>"><i class="fa fa-dashboard fa-fw"></i> <?php echo($userMenuList['menu_dashboard']);?></a>
                            </li>
                        <?php }?>
                        <?php if(array_key_exists('menu_hotel', $userMenuList)) {?>
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <?php if(array_key_exists('menu_hotel', $userMenuList)) {?>
                                        <li>
                                            <a href="<?php echo base_url();?>hotelAdmin/hotel" class="<?php if($this->uri->segment(2) == 'hotel') {echo('active');}?>"><?php echo($userMenuList['menu_hotel']);?></a>
                                        </li>
                                    <?php }?>
                                    <?php if(array_key_exists('menu_oboAutoOrderSetting', $userMenuList)) {?>
                                        <li>
                                            <a href="<?php echo base_url();?>hotelAdmin/oboAutoOrderSetting" class="<?php if($this->uri->segment(2) == 'oboAutoOrderSetting') {echo('active');}?>"><?php echo($userMenuList['menu_oboAutoOrderSetting']);?></a>
                                        </li>
                                    <?php }?>
                                    <?php if(array_key_exists('menu_lastMinutePolicy', $userMenuList)) {?>
                                        <li>
                                            <a href="<?php echo base_url();?>hotelAdmin/lastMinutePolicy" class="<?php if($this->uri->segment(2) == 'lastMinutePolicy') {echo('active');}?>"><?php echo($userMenuList['menu_lastMinutePolicy']);?></a>
                                        </li>
                                    <?php }?>
                                    <?php if(array_key_exists('menu_lastMinuteRoom', $userMenuList)) {?>
                                        <li>
                                            <a href="<?php echo base_url();?>hotelAdmin/lastMinuteRoom" class="<?php if($this->uri->segment(2) == 'lastMinuteRoom') {echo('active');}?>"><?php echo($userMenuList['menu_lastMinuteRoom']);?></a>
                                        </li>
                                    <?php }?>
                                    <?php if(array_key_exists('menu_rebate', $userMenuList)) {?>
                                        <li>
                                            <a href="<?php echo base_url();?>hotelAdmin/rebate" class="<?php if($this->uri->segment(2) == 'rebate') {echo('active');}?>"><?php echo($userMenuList['menu_rebate']);?></a>
                                        </li>
                                    <?php }?>
                                </ul>
                                <!-- /.nav-second-level -->
                         ...
                         <?php if(array_key_exists('menu_order', $userMenuList)) {?>
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    ...
                                    <li>
                                        <a href="<?php echo base_url();?>hotelAdmin/order/obo" class="<?php if($this->uri->segment(3) == 'obo' || $this->uri->segment(6) == '3') {echo('active');}?>">一口價</a>
                                    </li>
                                </ul>
                                <!-- /.nav-second-level -->
                            </li>
        ...
        <!-- Page Content -->
        <div id="page-wrapper">
            <?php $this->load->view('hotelAdmin/' . $view, $contentData);?>
        </div>
        <!-- /#page-wrapper -->
